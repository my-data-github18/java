...
System.out.println("7. To add data in .bin file");
System.out.println("8. To display data from .bin file");
System.out.println("9. to add data in .db file");
System.out.println("10. to display data from .db file");
